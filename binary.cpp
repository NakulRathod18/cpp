...
int main()
{
    ...
    cout<<(a^b)<<endl;   // (1010 ^ 1101) = 0111 = 7
    cout<<(a^c)<<endl;   // (1010 ^ 0110) = 1100 = 12
    cout<<(a^d)<<endl;   // (1010 ^ 1111) = 0101 = 5
    cout<<(b^c)<<endl;   // (1101 ^ 0110) = 1011 = 11
    cout<<(b^d)<<endl;   // (1101 ^ 1111) = 0010 = 2
    cout<<(c^d)<<endl;   // (0110 ^ 1111) = 1001 = 9
}